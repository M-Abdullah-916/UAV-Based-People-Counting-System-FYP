...
class Login:
    ...
    def login_screen(self):
        ...
        add_image_button = Button(self.main, text='Login', command=self.check_credentials, bg='white', fg='black', width=30,
                                  height=2)
...
if __name__ == '__main__':
    splash_screen()
    login_object = Login()
    splashWindow.after(3500, login_object.login_screen())
